...
def __part1by1_64(n):
    # binary: 11111111111111111111111111111111,                                len: 32
    n &= 0x00000000ffffffff
    # binary: 1111111111111111000000001111111111111111,                        len: 40
    n = (n | (n << 16)) & 0x0000FFFF0000FFFF
    # binary: 11111111000000001111111100000000111111110000000011111111,        len: 56
    n = (n | (n << 8)) & 0x00FF00FF00FF00FF
    # binary: 111100001111000011110000111100001111000011110000111100001111,    len: 60
    n = (n | (n << 4)) & 0x0F0F0F0F0F0F0F0F
    # binary: 11001100110011001100110011001100110011001100110011001100110011,  len: 62
    n = (n | (n << 2)) & 0x3333333333333333
    # binary: 101010101010101010101010101010101010101010101010101010101010101, len: 63
...
def __part1by2_64(n):
    # binary: 111111111111111111111,                                         len: 21
    n &= 0x1fffff
    # binary: 11111000000000000000000000000000000001111111111111111,         len: 53
    n = (n | (n << 32)) & 0x1f00000000ffff
    # binary: 11111000000000000000011111111000000000000000011111111,         len: 53
    n = (n | (n << 16)) & 0x1f0000ff0000ff
    # binary: 1000000001111000000001111000000001111000000001111000000001111, len: 61
    n = (n | (n << 8)) & 0x100f00f00f00f00f
    # binary: 1000011000011000011000011000011000011000011000011000011000011, len: 61
    n = (n | (n << 4)) & 0x10c30c30c30c30c3
    # binary: 1001001001001001001001001001001001001001001001001001001001001, len: 61
