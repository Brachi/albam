...
The package keeps its three jobs apart - the keyframe codec, reading a file in,
writing one back out - and holds here the custom properties both halves share,
since they are the shape the data takes while it sits in a .blend.

Importing the submodules is what runs their registry decorators, so it has to
happen even though nothing here calls into them.
"""
import bpy
