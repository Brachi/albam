...
class Sbc211(ReadWriteKaitaiStruct):
    def __init__(self, _io=None, _parent=None, _root=None):
        super(Sbc211, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self

    def _read(self):
        self.header = Sbc211.SbcHeader(self._io, self, self._root)
        self.header._read()
        self.sbc_info = []
        for i in range(self.header.num_objects):
            _t_sbc_info = Sbc211.Info(self._io, self, self._root)
            try:
                _t_sbc_info._read()
            finally:
        ...
        for i in range(self.header.num_pairs):
            _t_pairs_collections = Sbc211.SFacePair(self._io, self, self._root)
            try:
        ...
        for i in range(self.header.num_faces):
            _t_faces = Sbc211.Face(self._io, self, self._root)
            try:
                _t_faces._read()
            finally:
        ...
        for i in range(self.header.num_vertices):
            _t_vertices = Sbc211.Vertex(self._io, self, self._root)
            try:
                _t_vertices._read()
            finally:
        ...
        for i in range(self.header.num_stages):
            _t_collision_types = Sbc211.CollisionType(self._io, self, self._root)
            try:
        ...
        self.sbc_bvhc = []
        for i in range(self.header.num_objects):
            _t_sbc_bvhc = Sbc211.BvhCollision(self._io, self, self._root)
            try:
                _t_sbc_bvhc._read()
            finally:
                self.sbc_bvhc.append(_t_sbc_bvhc)

        self.bvh = Sbc211.BvhCollision(self._io, self, self._root)
        self.bvh._read()
        self._dirty = False
    ...
    def _write__seq(self, io=None):
        super(Sbc211, self)._write__seq(io)
    ...
    class AabbBlock(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.AabbBlock, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.AabbBlock, self)._write__seq(io)
            for i in range(len(self.x)):
                pass
    ...
    class Bbox4(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.Bbox4, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.Bbox4, self)._write__seq(io)
            for i in range(len(self.min)):
                pass
    ...
    class BvhCollision(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.BvhCollision, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _read(self):
            ...
            self.bounding_box = Sbc211.Bbox4(self._io, self, self._root)
            ...
            for i in range(self.num_nodes):
                _t_nodes = Sbc211.BvhNode(self._io, self, self._root)
                try:
                    _t_nodes._read()
                finally:
        ...
        def _write__seq(self, io=None):
            super(Sbc211.BvhCollision, self)._write__seq(io)
            for i in range(len(self.bvhc)):
                pass
    ...
    class BvhNode(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.BvhNode, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _read(self):
            ...
            self.min_aabb = Sbc211.AabbBlock(self._io, self, self._root)
            self.min_aabb._read()
            self.max_aabb = Sbc211.AabbBlock(self._io, self, self._root)
            self.max_aabb._read()
            self._dirty = False
        ...
        def _write__seq(self, io=None):
            super(Sbc211.BvhNode, self)._write__seq(io)
            for i in range(len(self.node_type)):
                pass
    ...
    class CollisionType(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.CollisionType, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.CollisionType, self)._write__seq(io)
    ...
    class Face(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.Face, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.Face, self)._write__seq(io)
            for i in range(len(self.normal)):
                pass
    ...
    class Info(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.Info, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.Info, self)._write__seq(io)
            self.bounding_box._write__seq(self._io)
            self._io.write_u4le(self.unk_01)
            for i in range(len(self.nulls_01)):
                pass
    ...
    class SFacePair(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.SFacePair, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.SFacePair, self)._write__seq(io)
    ...
    class SbcHeader(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.SbcHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.SbcHeader, self)._write__seq(io)
    ...
    class Vertex(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Sbc211.Vertex, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Sbc211.Vertex, self)._write__seq(io)
