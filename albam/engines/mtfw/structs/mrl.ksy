...
types:
  ...
  cb_app_reflect_shadow_light:  # 774
    instances:
      size_:
        value: 16
    seq:
  ...
  cb_dd_material_param_inner_correct:  #782
    instances:
      size_:
        value: 16
    seq:
