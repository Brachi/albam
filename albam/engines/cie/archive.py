...
class LfsWrapper:
    ...
    def __init__(self, file_path):
        ...
        self.file_type = self._get_all_extensions(file_path)[0]  # file extension without .lfs
    ...
    def decompress(self):
        ...
        if self.file_type == ".udas":
            ...
            evd = Evd.from_bytes(decompressed)
            evd._read()
            return evd
        else:
    ...
    def get_file_entries(self):
        ...
        if self.file_type == ".udas":
            ...
            evd = self.parsed
            for i, fe in enumerate(evd.file_entries):
                fe.file_path_with_ext = fe.name_file
                file_entries.append(fe)
        return file_entries
