...
class Dat(ReadWriteKaitaiStruct):
    ...
    def _read(self):
        self.header = Dat.DatHeader(self._io, self, self._root)
        self.header._read()
        self._dirty = False
    ...
    class DatHeader(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Dat.DatHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _read(self):
            ...
            self.file_extension = []
            for i in range(self.num_files):
                _t_file_extension = Dat.Extension(self._io, self, self._root)
                try:
        ...
        def _write__seq(self, io=None):
            super(Dat.DatHeader, self)._write__seq(io)
        ...
        def file_entries(self):
            ...
            for i in range(self.num_files):
                _t__m_file_entries = Dat.FileEntry(i, self._io, self, self._root)
                try:
        ...
        def file_size(self):
            ...
            self._m_file_size = self._io.size()
    ...
    class Extension(ReadWriteKaitaiStruct):
        def __init__(self, _io=None, _parent=None, _root=None):
            super(Dat.Extension, self).__init__(_io)
            self._parent = _parent
            self._root = _root
        ...
        def _write__seq(self, io=None):
            super(Dat.Extension, self)._write__seq(io)
    ...
    class FileEntry(ReadWriteKaitaiStruct):
        def __init__(self, i, _io=None, _parent=None, _root=None):
            super(Dat.FileEntry, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self.i = i
        ...
        def _write__seq(self, io=None):
            super(Dat.FileEntry, self)._write__seq(io)
        ...
        def raw_data(self):
            ...
            _pos = self._io.pos()
            self._io.seek(self._parent.offsets[self.i])
